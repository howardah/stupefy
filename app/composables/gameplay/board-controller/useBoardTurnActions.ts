...
import type { BoardViewState, CharacterCard } from "@shared/utils/types";
import { isCharacterPowerName } from "@shared/utils/types";
import Deck from "@shared/utils/deck";
import { handleRulePopupChoice } from "@shared/utils/gameplay/card-rules";
import { getPrimaryCharacter } from "@shared/utils/gameplay/core";
import { isGrayCard } from "@shared/utils/gameplay/powers";
import {
  endTurnState,
  incrementTurn,

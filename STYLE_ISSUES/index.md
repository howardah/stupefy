...
| [x]  | SI-07 | [SI-07-legacy-realtime-utilities-cleanup.md](./SI-07-legacy-realtime-utilities-cleanup.md) | Remove or deliberately rebuild legacy realtime helper modules that no longer match the current architecture.      |
